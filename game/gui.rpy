...
define gui.accent_color = '#7ecac3'

define gui.idle_color = '#aaaaaa'

define gui.idle_small_color = '#888888'

define gui.hover_color = '#c8f0ee'

define gui.selected_color = '#7ecac3'

define gui.insensitive_color = '#55555577'

define gui.muted_color = '#3a5a58'
define gui.hover_muted_color = '#5a8a88'

define gui.text_color = '#e8e8f0'
define gui.interface_text_color = '#ccccdd'
...
define gui.name_text_font = "fonts/Quicksand-Bold.ttf"

define gui.interface_text_font = "fonts/Quicksand-Regular.ttf"
...
define gui.choice_button_text_hover_color = '#e8e8ff'
define gui.choice_button_text_insensitive_color = '#55555577'
